...
##FOR VERIFY: 
On the mentioned PINS inside the user_main.c , connect a LED. The colors on the LED will change, with the for loop values.R connect GPIO12,G connect GPIO13,B connect GPIO14.